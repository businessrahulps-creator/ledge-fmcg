-- Fix trial period: spec says 14 days, RPC was setting 30
...
BEGIN
  ...
  VALUES (p_company_name, now() + interval '14 days')
...
-- Also update the column default so any direct inserts match the spec
