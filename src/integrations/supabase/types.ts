    ...
    Tables: {
      ...
      claim_lines: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "claim_lines_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
      ...
      profiles: {
        Row: {
          ...
          id: string
          phone: string
          role_self_selected: string | null
      ...
      secondary_sales: {
        ...
        Relationships: [
          {
            foreignKeyName: "secondary_sales_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "secondary_sales_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
