...
export default function RefundPolicy() {
  return (
    <div className="min-h-screen bg-white font-body antialiased scroll-smooth">
      <SeoHead
        title="Refund Policy — Ledge"
        description="Refund terms for paid subscriptions on the Ledge platform. Clear rules on cancellations, pro-rata refunds, and how to request one."
        path="/refund-policy"
      />
      <Navbar />
