...
export function Hero() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center px-6 md:px-8 lg:px-10 lp-block-ink lp-block-ink-hero pt-24 md:pt-28 pb-20 md:pb-24 overflow-hidden">
