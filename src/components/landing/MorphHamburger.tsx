  ...
  ({ open, onClick, className = "" }, ref) => {
    ...
    return (
      <motion.button
        ...
        aria-expanded={open}
        className={`md:hidden relative rounded-full bg-background/70 backdrop-blur-md border border-border w-9 h-9 flex items-center justify-center text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 shadow-[inset_0_0_0_1px_hsl(0_0%_100%/0.6),0_2px_8px_-4px_hsl(var(--primary)/0.12)] ${className}`}
      >
